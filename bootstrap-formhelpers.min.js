      ...
      for (country in countries) {
        if (countries.hasOwnProperty(country)) {
          if (this.options.flags === true) {
            $options.append('<li><a tabindex="-1" href="#" data-option="' + countries[country] + '"><i class="glyphicon bfh-flag-' + country + '"></i>' + countries[country] + '</a></li>');
          } else {
            $options.append('<li><a tabindex="-1" href="#" data-option="' + countries[country] + '">' + country + '</a></li>');
          }
        }
      }
...
+function ($) {
  ...
  BFHStates.prototype = {
    ...
    loadBootstrapStates: function(country) {
      ...
      for (state in BFHStatesList[country]) {
        if (BFHStatesList[country].hasOwnProperty(state)) {
          $options.append('<li><a tabindex="-1" href="#" data-option="' + BFHStatesList[country][state].name + '">' + BFHStatesList[country][state].name + '</a></li>');
